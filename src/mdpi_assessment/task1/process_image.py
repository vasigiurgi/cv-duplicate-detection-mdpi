...
from mdpi_assessment.logger import logger  # import logger
...
def process_image_file(image_path: Path, save_prefix: str = None) -> dict:
    ...
    logger.info(f"Saved images: original={original_save}, gray={gray_save}, blurred={blurred_with_gaussian_save}")
