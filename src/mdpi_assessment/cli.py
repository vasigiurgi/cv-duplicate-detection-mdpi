...
def task2_aggregate_from_scratch(src: Path, results_dir: Path, min_votes: int, ela_threshold: float)-> None: 
    ...
    click.echo(f"workflow completed, final candidates after forensic analysis: {len(final_results)}")
